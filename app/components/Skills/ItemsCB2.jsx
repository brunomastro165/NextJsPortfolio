...
const ItemsCB2 = (props) => {
    return (
        ...
        <li className="flex space-x-3 items-center text-center">
            ...
            <span className="text-base font-normal leading-tight text-gray-500 dark:text-gray-400">{props.descripcion}</span>
        </li>
    )
}
